<h1 align="center">Taokari LLVM</h1>
<h2 align="center">Forked from Arkari / inspired by Hikari</h2>
...
Currently supported features:
 ...
 - Or manage directly via configuration file (`-mllvm -taokari-cfg="Configuration file path|Your config path"`) (Win64-MT-20.1.7-obf1.7.0 or later)
...
Add to compilation parameters: `-mllvm -taokari-cfg="Configuration file path|Your config path"`
