...
- [ ] 🧪 Add decompiler-lift test for VMP functions.
...
- [ ] Finish MIR config keys per sub-pass.
...
- [ ] Add post-RA verifier gate to release mode.
- [ ] Add fallback when a machine function is unsafe for MIR transformation.
...
- [ ] Add `mobile` profile for smaller binaries.
...
2. [ ] Finish MIR config keys per sub-pass.
